...
module.exports = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(object) {
    ...
    var _config$maxHeight, maxHeight, _config$maxWidth, maxWidth, _config$thumbPrefix, thumbPrefix, _config$cacheControl, cacheControl, filePath, contentType, fileDir, fileName, thumbFilePath, tempLocalFile, tempLocalDir, tempLocalThumbFile, bucket, file, thumbFile, metadata, tokenConfig, results, thumbResult, originalResult, thumbFileUrl, fileUrl;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 25:
            ...
            _context.next = 31;
            return Promise.all([thumbFile.getSignedUrl(tokenConfig), file.getSignedUrl(tokenConfig)]);
          ...
          case 31:
            ...
            return _context.abrupt('return', { file: thumbFile, downloadURL: thumbFileUrl, fileDir: fileDir, fileName: fileName });
