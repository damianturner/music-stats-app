...
exports.default = function (folder, exports) {
  var extension = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '.f.js';
  ...
  for (var f = 0, fl = files.length; f < fl; f++) {
    var file = files[f];
    var functionName = (0, _camelcase2.default)(file.split(extension).join('').split('/').join('_')); // Strip off '.f.js'
