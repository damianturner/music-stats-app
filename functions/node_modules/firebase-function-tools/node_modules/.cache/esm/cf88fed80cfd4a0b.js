let database,admin,moment,usersUtil;_0cf‍.x([["default",()=>_0cf‍.o]]);_0cf‍.w("firebase-functions",[["database",["database"],function(v){database=v}]]);_0cf‍.w("firebase-admin",[["default",["admin"],function(v){admin=v}]]);_0cf‍.w("moment",[["default",["moment"],function(v){moment=v}]]);_0cf‍.w("firebase-function-tools/lib/users",[["default",["usersUtil"],function(v){usersUtil=v}]]);




_0cf‍.d(database.ref('/users_count').onDelete((data, context) => {
