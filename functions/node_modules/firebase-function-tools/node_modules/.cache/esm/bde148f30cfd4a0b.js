let database,admin;_0cf‍.w("firebase-functions",[["database",["database"],function(v){database=v}]]);_0cf‍.w("firebase-admin",[["default",["admin"],function(v){admin=v}]]);
  ...
  .onWrite((eventSnapshot, context) => {
    ...
    return roleGrantsRef.once('value').then(snapshot => {
      ...
      snapshot.forEach(grant => {
        ...
        _0cf‍.g.console.log('User role changed:', eventSnapshot.after.val())
