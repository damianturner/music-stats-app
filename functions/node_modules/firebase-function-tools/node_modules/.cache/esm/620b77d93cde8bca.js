let functions,admin,moment,nodemailer;_3cd‍.x([["default",()=>_3cd‍.o]]);_3cd‍.w("firebase-functions",[["*",null,function(v){functions=v}]]);_3cd‍.w("firebase-admin",[["default",["admin"],function(v){admin=v}]]);_3cd‍.w("moment",[["default",["moment"],function(v){moment=v}]]);_3cd‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);
...
_3cd‍.d(functions.auth.user().onCreate((uRecord, context) => {
  ...
  return admin
    ...
    .then(user => {
      ...
      _3cd‍.g.console.log('Event user data', userRecord)

      // User with provider data
      _3cd‍.g.console.log('Auth user data', user)
