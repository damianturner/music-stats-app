let functions,admin,moment,nodemailer;_ffc‍.x([["default",()=>_ffc‍.o]]);_ffc‍.w("firebase-functions",[["*",null,function(v){functions=v}]]);_ffc‍.w("firebase-admin",[["default",["admin"],function(v){admin=v}]]);_ffc‍.w("moment",[["default",["moment"],function(v){moment=v}]]);_ffc‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);
...
_ffc‍.d(functions.auth.user().onDelete((userMetadata, context) => {
  const uid = userMetadata.uid
  const email = userMetadata.email
  const displayName = userMetadata.displayName

  _ffc‍.g.console.log(userMetadata.providerData)
  _ffc‍.g.console.log(userMetadata)
  _ffc‍.g.console.log(context)
  ...
  const sendEmail = mailTransport.sendMail(mailOptions).then(() => {
    _ffc‍.g.console.log('Account deletion confirmation email sent to:', email)
    return null
  })
